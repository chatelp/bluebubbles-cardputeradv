...
enum StrId : uint8_t {
    ...
    S_ABOUT, S_ABOUT_BY, S_ABOUT_TOOL, S_ABOUT_NOAI, S_ABOUT_DIRECT, S_ABOUT_DIRECT2, S_HINT_ABOUT,
...
static const char* const kStrings[S_COUNT][LANG_COUNT] = {
    ...
    {"Info", "Infos"},
    {"p test  s settings  a about  ` back", "p tester  s reglages  a propos  ` retour"},
    ...
    {"About", "A propos"},
    {"by Pierre Chatel", "par Pierre Chatel"},
    {"built with Claude Code", "construit avec Claude Code"},
    {"no AI runs on this device", "aucune IA ne tourne sur l'appareil"},
    {"your Mac, your device", "votre Mac, votre appareil"},
